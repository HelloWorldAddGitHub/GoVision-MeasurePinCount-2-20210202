...
namespace GoVision
{
    public partial class PinCameraForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            VisionMgr.GetInstance().BindWindow(VisionStepName.PinMea, visionControl1);
        ...
        private void btnDrawMeasure_Click(object sender, EventArgs e)
        {
            ...
            //HOperatorSet.GenRectangle2(out mea.LineEdge, row, column, phi, length1, length2);

            MeasureMgr.GetInstance().MeasureList.Add(mea);

            //HTuple rowMode, columnMode, radianMode, transRow, transColumn, transRadian;
            //HDevelopExport.FindModelProcess(vision.imgSrc, visionControl1, out rowMode, out columnMode, out radianMode);
        ...
        private void SubValueChanged()
        {
            ...
            nudCountPinMea.ValueChanged -= nudDisEdge_ValueChanged;
            ...
            if (vision.imgSrc != null && vision.imgSrc.IsInitialized())
            {
                ...
                if (row.Length > 0)
                {
                    ...
                    foreach (var mea in MeasureMgr.GetInstance().MeasureList)
                    {
                        ...
                        //HOperatorSet.HomMat2dRotate(homMat2D, 0 - radModel, mea.CenterRow - row, mea.CenterColumn - column, out homMat2D);
